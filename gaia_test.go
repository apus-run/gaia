	...
	tests := []fields{
		{
			...
			want: struct {
				...
				id: "1", version: "v1", name: "gaia-v1", endpoint: []string{"https://apus.run", "localhost"},
				metadata: map[string]string{},
			},
		},
		{
			...
			metadata: map[string]string{"gaia": "https://github.com/apus-run"},
			version:  "v2",
			want: struct {
				id       string
				version  string
				...
				id: "2", version: "v2", name: "gaia-v2", endpoint: []string{"test"},
				metadata: map[string]string{"gaia": "https://github.com/apus-run"},
			},
		},
		{
			...
			want: struct {
				...
				id: "3", version: "v3", name: "gaia-v3", endpoint: nil,
				metadata: map[string]string{},
			},
		},
	}
