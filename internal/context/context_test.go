...
func TestContext(t *testing.T) {
	type ctxKey1 struct{}
	type ctxKey2 struct{}
	ctx1 := context.WithValue(context.Background(), ctxKey1{}, "https://github.com/apus-run/gaia")
	...
	if !reflect.DeepEqual(value1, "https://github.com/apus-run/gaia") {
		t.Errorf("expect %v, got %v", "https://github.com/apus-run/gaia", value1)
	}
